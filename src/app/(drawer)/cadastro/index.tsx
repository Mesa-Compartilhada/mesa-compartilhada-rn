                    ...
                    >
                        <ScrollView className="flex-1" contentContainerStyle={{ padding: 24, gap: 20 }}>
                            <View className="gap-2">
                                <Text className="text-lg font-bold text-azulEscuro ml-1">CNPJ</Text>
                                <InputDefault 
                                    value={values.cnpj}
                                    onChangeText={handleChange("cnpj")}
                                    onBlur={handleBlur("cnpj")}
                                    Icon={<MaterialIcons name="business-center" color="#62C0C0" size={24} />} 
                            ...
                            <View className="gap-2">
                                <Text className="text-lg font-bold text-azulEscuro ml-1">Nome fantasia</Text>
                                <InputDefault 
                                    value={values.nome}
                                    onChangeText={handleChange("nome")}
                                    onBlur={handleBlur("nome")}
                                    Icon={<MaterialIcons name="account-circle" color="#62C0C0" size={24} />} 
                            ...
                            <View className="gap-2">
                                ...
                                <InputDefault 
                                    ...
                                    Icon={<MaterialIcons name="email" color="#62C0C0" size={24} />} 
                            ...
                            <View className="gap-2">
                                ...
                                <InputDefault 
                                    ...
                                    Icon={<MaterialIcons name="lock" color="#62C0C0" size={24} />} 
                                    placeholder="******" 
                                    error={errors.senha}
                                    autoCapitalize="none"
                                    isPassword={true}
                            ...
                            <View className="gap-2">
                                <Text className="text-lg font-bold text-azulEscuro ml-1">Confirme sua senha</Text>
                                <InputDefault 
                            ...
                            <View className="gap-4">
                                <View className="gap-2">
                                    <Text className="text-lg font-bold text-azulEscuro ml-1">Tipo da empresa</Text>
                                    <PickerDefault values={TiposEmpresa} onChange={(key) => setFieldValue("tipo", key)} />
                                </View>
                                
                                <View className="gap-2">
                                    <Text className="text-lg font-bold text-azulEscuro ml-1">Categoria da empresa</Text>
                            ...
                            <View className="gap-2">
                                <Text className="text-lg font-bold text-azulEscuro ml-1">CEP</Text>
                                <InputDefault 
                                    value={values.cep}
                                    onChange={async (e) => {
                                    ...
                                    Icon={<MaterialIcons name="location-on" color="#62C0C0" size={24} />} 
                            ...
                            <View className="gap-2 mb-8">
                                <Text className="text-lg font-bold text-azulEscuro ml-1">Número</Text>
                                <InputDefault 
                                    value={values.numero}
                                    onChangeText={handleChange("numero")}
                                    onBlur={handleBlur("numero")}
                                    Icon={<MaterialIcons name="home" color="#62C0C0" size={24} />} 
                                    placeholder="000" 
                                    error={errors.numero}
                                    autoCapitalize="none"
                                />
